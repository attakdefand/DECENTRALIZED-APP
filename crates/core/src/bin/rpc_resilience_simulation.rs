...
fn test_realistic_rpc_resilience_scenario() {
    ...
    manager
        .update_provider_health("infura_mainnet", ProviderHealth::Healthy)
        .unwrap();
...
fn test_rpc_resilience_error_scenarios() {
    ...
    let health_update_result =
        manager.update_provider_health("non_existent", ProviderHealth::Healthy);
