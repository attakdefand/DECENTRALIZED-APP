...
impl OptimisticBridge {
    ...
    pub fn challenge_transfer(&mut self, challenge: Challenge) -> Result<()> {
        ...
        let transfer_found = self
            .transfers
            .iter()
            .find(|t| t.id == challenge.transfer_id);
...
impl ZkBridge {
    ...
    pub fn submit_transfer_with_proof(
        &mut self,
