//! Resilience and Availability Simulation Tests
//!
//! This module contains tests that simulate various resilience and availability scenarios
//! to verify the effectiveness of our resilience measures.
