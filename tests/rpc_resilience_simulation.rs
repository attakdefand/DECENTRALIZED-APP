//! RPC Resilience Simulation Tests
//!
//! This module contains tests that simulate various RPC resilience scenarios
//! to verify the effectiveness of our RPC resilience measures.
...
fn test_realistic_rpc_resilience_scenario() {
    ...
    assert_eq!(prioritized[0].name, "infura_mainnet");
    assert_eq!(prioritized[1].name, "alchemy_mainnet");
    assert_eq!(prioritized[2].name, "quicknode_mainnet");
    assert_eq!(prioritized[3].name, "self_hosted_node");
